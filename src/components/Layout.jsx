...
export default function Layout() {
  ...
  // Cierra drawer al pasar a desktop (evita que quede “abierto” escondido)
  useEffect(() => {
    const onResize = () => {
            ...
            <footer className="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              ...
              <div className="px-5 py-4">
                ...
                <div className="mt-4 text-xs leading-relaxed text-slate-500">
                  © {new Date().getFullYear()} Sun Power ABC. This portal is provided for
                  onboarding and internal employee workflow tracking.
                </div>
              </div>
            </footer>
          </div>
